...
for league in leagues:
    ...
    df = pd.read_csv(f"results/roi/{league}_binned_roi.csv")
    ...
    plt.ylabel("ROI")
    plt.title("Favorite vs Underdog ROI by Probability Bin")
    plt.legend()
    plt.savefig(f"figures/roi/{league}_binned_roi.png")
