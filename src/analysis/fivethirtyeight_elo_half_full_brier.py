...
output_file = "results/fivethirtyeight_elo/fivethirtyeight_elo_half_full_brier.csv"
...
results.append([f"nfl_full_fivethirtyeight_elo", brier_score_overall])
...
results.append([f"nfl_half_fivethirtyeight_elo", brier_score_late])
