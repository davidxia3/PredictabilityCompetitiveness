...
for league in leagues:
    ...
    total_df_out.to_csv(f"results/roi/total_roi.csv", index=False)
    ...
    df_out.to_csv(f"results/roi/{league}_binned_roi.csv", index=False)
    ...
    df_out.to_csv(f"results/roi/{league}_seasonal_binned_roi.csv", index=False)
